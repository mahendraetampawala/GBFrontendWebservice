...
public String setproductlabels()
{
		...
		while (rs.next())
		{
			...
			output += "<center><div class=\"review\">";
			...
			output += itemPrice;  
			output +="<br>";
			output +="<input type=\"button\" value=\"Order\"class=\"btn btn-danger remove\">";
			output +="<br>";
			output +="<center><i class=\"fab fa-cc-visa\"></i>";
			output +="<i class=\"fab fa-cc-paypal\"></i>";
			output +="<i class=\"fab fa-cc-mastercard\" width='30px'></i></center>";
			output += "</div>";                     
			output += "</div>";                  
			output += "</div>";           
			output += "</div>";        
