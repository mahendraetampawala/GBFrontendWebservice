<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%><%@page import = "com.Item" %><%@page import = "com.feedback" %>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
                        ...
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="feedback.jsp" class="dropdown-item">Customer Login</a>
                                    <a href="my-account.jsp" class="dropdown-item">Seller Login</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="index.jsp">
                                <img src="img/GBlogo.jpeg" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="header-slider normal-slider">
                            <div class="header-slider-item">
                                <img src="img/tech-Gadgets-.jpg" alt="Slider Image" width="1100px"/>
                                <div class="header-slider-caption">
                                    
                                    <a class="btn" href="#divItemsGrid"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                                </div>
                            </div>
        ...
        <div class="call-to-action">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <a href="tel:769917579">+94769917579</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="featured-product product">
            <div class="container-fluid">
                <div class="section-header" id="divItemsGrid">
                    <h1> Products</h1>
                </div>
